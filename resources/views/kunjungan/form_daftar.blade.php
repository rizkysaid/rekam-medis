...
!!}	
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            {!! Form::select('id_gender', $gender, null, ['class' => 'form-control select2 required', 'id'=>'id_gender', 'placeholder' => 'Pilih Jenis Kelamin...']); !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            {!! Form::select('id_poli', $poli, null, ['class' => 'form-control select2 required', 'id'=>'id_poli', 'placeholder' => 'Pilih Poli...']); !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            {!! Form::select('id_spesialis', $spesialis, null, ['class' => 'form-control select2 required', 'id'=>'id_spesialis', 'placeholder' => 'Pilih Spesialisasi...']); !!}
        </div>
    </div>
